    ...
    document.querySelectorAll('.product').forEach(product => {
        ...
        addButton.addEventListener('click', () => {
            ...
            if (cartProduct) {
                ...
                const cartProductCountElement = cartProduct.querySelector('.cart__product-count');
                cartProductCountElement.textContent = parseInt(cartProductCountElement.textContent) + quantity;
            } else {
